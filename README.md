...
* *Active[s,l]* = *Active[s,l-1]* U {u: |N(u) ∩ *Active[s,l-1]*| ≥ t(u) - s(u)}, ∀l>0. <br>
Un **vettore target** s è un'assegnazione di incentivi parziali che innesca un pro-
cesso di attivazione che influenza l'intera rete, cioè tale che *Active[s,l]* = V per un *l*≥0. L'obiettivo è trovare il vettore s che minimizza il totale degli incentivi per avere *Active[0,∞]* = V , cioe un vettore s che minimizzi: 
<div float="center"> *C(s) = Σ s(v) ∀ v ∈ V </div>
